...
def extractForecastTimeseriesInDays(timeseries):
    print('extractForecastTimeseriesInDays|timeseries : ', timeseries)
    print('save_forecast_timeseries | timeseries[0] : ', timeseries[0])
    print('save_forecast_timeseries | timeseries[-1] : ', timeseries[-1])
    """
    ...
    if len(timeseries) > 0:
        ...
        if len(group_timeseries) > 0:
            new_timeseries.append(group_timeseries[:])
    print('save_forecast_timeseries | len(new_timeseries) : ', len(new_timeseries))
    return new_timeseries
